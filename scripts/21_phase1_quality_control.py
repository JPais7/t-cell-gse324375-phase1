...
hold_candidates=ready.loc[ready.phase2_decision.eq('HOLD'),'candidate']
leading_hold='NONE' if hold_candidates.empty else x[x.candidate.isin(hold_candidates)].sort_values(['evidence_score','candidate'],ascending=[False,True]).iloc[0].candidate
