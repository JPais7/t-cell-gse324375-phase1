...
cols=["candidate","candidate_type","mechanism_class","source","target","ligand","receptor","target_lineage","effect_size","FDR","n_mice","n_mice_supporting","n_mice_opposing","direction_consistency","n_cells","effective_sample_size","RNA_evidence","ADT_evidence","data_driven_state_evidence","temporal_support","interaction_evidence","independence_from_curated_score","power_flag"]
