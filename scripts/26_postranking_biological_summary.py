...
if src.exists() and ready_path.exists():
 ...
 lines=['# Phase 1.5 final report','',f'Leading GO: {lg}',f'Leading HOLD: {lh}','',('No candidate passes every closed Phase 2 readiness gate.' if lg=='NONE' else f'Leading GO candidate: {lg}')]
